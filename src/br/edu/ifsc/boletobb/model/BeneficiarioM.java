...
public class BeneficiarioM {
    ...
    private EnderecoM bene_endereco;

    public BeneficiarioM(String bene_nome, String bene_agencia, String bene_digito_agencia, String bene_codigo_beneficiario, String bene_digito_codigo_beneficiario, String bene_numero_convenio, String bene_carteira, String bene_nosso_numero, EnderecoM bene_endereco) {
    ...
    public EnderecoM getBene_endereco() {
        return bene_endereco;
    }

    public void setBene_endereco(EnderecoM bene_endereco) {
        this.bene_endereco = bene_endereco;
    }
